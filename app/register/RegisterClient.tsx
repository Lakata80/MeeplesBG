    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900">Създай акаунт</h1>
          <p className="mt-2 text-gray-500">Присъедини се към MeeplesBG</p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-gray-50 text-gray-400">или с имейл</span>
          </div>
        </div>
        ...
        <form action={действие} className="space-y-4">
          ...
          <p className="text-xs text-gray-400 text-center">
            С регистрацията приемаш нашите условия за ползване.
          </p>
        </form>
